        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            {isLoggedIn ? (
              ...
              <>
                <a href="/login" className="text-gray-700 hover:text-black transition font-medium">
                  Login
                </a>
                <a href="/signup" className="bg-black text-white px-4 py-2 rounded-lg hover:opacity-90 transition font-medium">
                  Signup
                </a>
              </>
            )}
